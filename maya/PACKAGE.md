...
Two things, and they fit together: **Maya (the chat UI)** and **the automation
platform she calls**.

```
maya/
├── frontend/                     ← MAYA, THE CHAT
│   ├── mantrac-support-v8.html     your original, untouched
│   ├── mantrac-support-v9.html     ★ v8 + the equipment capability — open this
│   ├── maya-equipment.js           the tool layer that was added to her
...
├── schemas/                      equipment JSON Schema + Maya's tool definitions
...
Open `frontend/mantrac-support-v9.html` in a browser. Maya works exactly as
