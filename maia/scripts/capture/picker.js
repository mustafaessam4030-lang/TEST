/* ══════════════════════════════════════════════════════════════════════════
   MAIA SELECTOR PICKER — injected into the live page during capture.
   ──────────────────────────────────────────────────────────────────────────
   ...
   ══════════════════════════════════════════════════════════════════════════ */
(() => {
  if (window.__maiaPicker) return;               // idempotent across SPA re-renders

  // Attributes we must never build a selector from.
  //  - data-maia-fixture: only exists in our own offline test fixture
  //  - ng-*/cdk-*/_ngcontent-*: framework bookkeeping, changes per build
  const BANNED_ATTRS = ['data-maia-fixture', 'data-maia-probe'];
  ...
  const onKey = (e) => {
    ...
    if (e.key === 'Escape') {
      ...
      if (window.__maiaSkipBinding) window.__maiaSkipBinding('skipped');
    }
  };
  ...
  function emit(el) {
    window.__maiaPicked = el;
    if (window.__maiaPickBinding) window.__maiaPickBinding(build(el));
  }
  ...
  window.__maiaActivate = activate;
})();
