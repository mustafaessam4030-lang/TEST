...
| Code | HTTP | Retryable | Detection | Maia says (substance) |
|---|---|---|---|---|
...
* Maia is told *once* about the outcome, never about the attempts, except in the
...
| Condition | Behaviour |
|---|---|
| SIS slow | 202 + run id, Maia offers to report back |
